...
//	@"useTheme",
	...
	[NSNotificationCenter.defaultCenter addObserverForName:AZThemeDidUpdateNotification object:nil queue:NSOperationQueue.mainQueue usingBlock:^(NSNotification *note) {
		
		NSLog(@"Theme changed somehow!");
...
//								? [aDecoder decodeObjectForKey:			@"themeKey"] : 
//		@"atoz";
//		@"gradientTheme";
...
- (BGTheme *)theme {
	return BGThemeManager.sharedManager.activeTheme;
