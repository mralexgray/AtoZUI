...
{
	return [[ NSGradient alloc] initWithStartingColor: [NSColor colorWithCalibratedWhite: 0.35 alpha: [self alphaValue]]
										  endingColor: [NSColor colorWithCalibratedWhite: 0 alpha:[self alphaValue]]];
